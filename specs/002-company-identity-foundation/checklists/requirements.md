...
- **Constitution-mandated sections**: Per Principle XXII, this spec documents API
  ...
  conventions to be reconciled with the Backend P001 OpenAPI contract during `/speckit-plan`;
  they are dependencies, not implementation prescriptions.
- **Technology references**: The framework/library names appearing in cross-cutting
  requirements (TanStack Query, Axios, React Hook Form, Zod) restate binding Constitution
  architectural mandates the feature must comply with, not new design choices.
